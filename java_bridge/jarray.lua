...
-- ============================================================
function jarray.create(jobject_raw)
   local self = jobject.create(jobject_raw) -- call superclass ctor
...
function jarray:__len()
   return lj_get_array_length(self.jobject_raw)
end
...
function jarray:__index(key)
   ...
   elseif type(key) == "number" then
	  local ret_val = lj_get_array_element(self.jobject_raw, self.class.name, key)
